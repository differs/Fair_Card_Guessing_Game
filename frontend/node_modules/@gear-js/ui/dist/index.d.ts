...
type Props$a = Omit<InputHTMLAttributes<HTMLInputElement>, 'size'> & InputProps & {
    icon?: SVGComponent;
};
...
type Props$7 = Omit<SelectHTMLAttributes<HTMLSelectElement>, 'size'> & InputProps & {
    options: OptionHTMLAttributes<HTMLOptionElement>[];
};
declare const Select: react.ForwardRefExoticComponent<Props$7 & react.RefAttributes<HTMLSelectElement>>;

type Props$6 = TextareaHTMLAttributes<HTMLTextAreaElement> & InputProps;
...
type Props$4 = Omit<InputHTMLAttributes<HTMLInputElement>, 'size' | 'value' | 'onChange' | 'accept'> & Omit<InputProps, 'color'> & {
