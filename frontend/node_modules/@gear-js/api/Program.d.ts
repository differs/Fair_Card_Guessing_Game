...
export declare class GearProgram extends GearTransaction {
     ...
     */
    upload(args: IProgramUploadOptions, metaOrHexRegistry?: ProgramMetadata | HexString, typeName?: string): IProgramUploadResult;
    /**
     ...
     */
    create(args: IProgramCreateOptions, metaOrHexRegistry?: HexString | ProgramMetadata, typeName?: number | string): IProgramCreateResult;
    /**
     * ### Pay program rent
     * @param programId
     * @param blockCount
